...
Shader "VHS"
{
	Properties
	{
		...
		_VignetteRadiuse("Vignette Radiuse", Float) = 0.22
	...
	SubShader
	{
		...
		uniform float _VignetteRadiuse;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 temp_output_32_0 = ( ( ( (float3( -1,-1,-1 ) + (smoothstepResult75 - float3( 0,0,0 )) * (float3( 1,1,1 ) - float3( -1,-1,-1 )) / (float3( 1,1,1 ) - float3( 0,0,0 ))) * temp_output_42_0 ) * float3( ( appendResult59 * temp_output_42_0 ) ,  0.0 ) ) + float3( uv_MainTex ,  0.0 ) );
			float pixelWidth87 =  1.0f / _SubdiscretizationX;
			float pixelHeight87 = 1.0f / _SubdiscretizationY;
			half2 pixelateduv87 = half2((int)((temp_output_32_0).xy.x / pixelWidth87) * pixelWidth87, (int)((temp_output_32_0).xy.y / pixelHeight87) * pixelHeight87);
			...
			float3 appendResult68 = (float3(mul( float3x3(0.299,0.587,0.114,-0.14713,-0.28886,0.436,0.615,-0.51499,-0.10001), tex2D( _MainTex, temp_output_32_0.xy ).rgb ).x , break66.y , break66.z));
			float temp_output_2_0_g16 = 0.98;
			float temp_output_3_0_g16 = 0.98;
			float2 appendResult21_g16 = (float2(temp_output_2_0_g16 , temp_output_3_0_g16));
			float Radius25_g16 = max( min( min( abs( ( _VignetteRadiuse * 2 ) ) , abs( temp_output_2_0_g16 ) ) , abs( temp_output_3_0_g16 ) ) , 1E-05 );
			float2 temp_cast_8 = (0.0).xx;
			float temp_output_30_0_g16 = ( length( max( ( ( abs( (uv_MainTex*2.0 + -1.0) ) - appendResult21_g16 ) + Radius25_g16 ) , temp_cast_8 ) ) / Radius25_g16 );
			float temp_output_142_0 = saturate( (0.0 + (( 1.0 - temp_output_30_0_g16 ) - 0.0) * (1.0 - 0.0) / (0.3 - 0.0)) );
			float smoothstepResult143 = smoothstep( 0.0 , 1.0 , ( temp_output_142_0 * temp_output_142_0 ));
			o.Emission = ( lerpResult111 * float4( ( ( _GlitchBrightness * smoothstepResult75 * temp_output_42_0 ) + mul( float3x3(1,0,1.13983,1,-0.39465,-0.5806,1,2.03211,0), appendResult68 ) ) , 0.0 ) * smoothstepResult143 ).rgb;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-1298.594,-17.03015;Inherit;False;Property;_ScanWidth;Scan Width;2;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-910.8235,-509.4601;Inherit;False;Property;_Glitch;Glitch;0;0;Create;False;0;0;0;False;0;False;0.0005;0.02;0;0.02;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;99;1976.681,-1084.91;Inherit;True;Property;_Subpixel;Subpixel;7;0;Create;True;0;0;0;False;0;False;-1;None;bd2afbde847202a4b9e764c064138f9a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;117;1475.89,-657.071;Inherit;False;Property;_FadeDistance;Fade Distance;8;1;[RemapSliders];Create;True;0;0;0;False;0;False;0,0;0.1137932,0.7172413;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;100;3095.73,-253.1855;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;3247.931,-291.9383;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;VHS;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;458.3017,-395.7526;Inherit;False;Property;_GlitchBrightness;Glitch Brightness;1;0;Create;True;0;0;0;False;0;False;0;0.64;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;65;1017.735,139.4388;Inherit;False;RGB to YUV;-1;;12;1ed4207bbc7c91b469b45347cc23eb5f;0;1;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;69;1551.99,-176.0298;Inherit;False;YUV to RGB;-1;;13;41a6967b00edbeb4d9592156913ec406;0;1;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;70;-1717.88,-1097.397;Inherit;True;Property;_Noise;Noise;3;0;Create;True;0;0;0;False;0;False;-1;None;05b1d9d0d8f3cf146a24b3385b2a1076;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;88;89.492,375.7232;Inherit;False;Property;_SubdiscretizationX;Subdiscretization X;5;0;Create;True;0;0;0;False;0;False;1024;160;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;89;103.792,457.6233;Inherit;False;Property;_SubdiscretizationY;Subdiscretization Y;6;0;Create;True;0;0;0;False;0;False;1024;120;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;93;96.7742,294.9794;Inherit;False;True;True;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;63;688.7706,-197.177;Inherit;False;RGB to YUV;-1;;5;1ed4207bbc7c91b469b45347cc23eb5f;0;1;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BreakToComponentsNode;67;890.5084,-195.9882;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.DynamicAppendNode;68;1399.99,-188.0298;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;71;-2273.28,-1094.098;Inherit;False;0;70;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;78;105.44,63.22182;Inherit;True;Property;_MainTex;MainTex;4;0;Create;False;0;0;0;False;0;False;None;7f51e64675a5e264fbd5729a07872b1d;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleAddOpNode;32;14.8439,-324.0104;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;4;-307.5877,-293.8079;Inherit;False;0;78;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;127;1775.876,-423.4199;Inherit;False;Constant;_Float2;Float 2;12;0;Create;True;0;0;0;False;0;False;0.98;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;128;1773.876,-499.4199;Inherit;False;Constant;_Float3;Float 2;12;0;Create;True;0;0;0;False;0;False;0.98;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;139;1967.416,-454.7686;Inherit;True;Rounded Rectangle;-1;;16;8679f72f5be758f47babb3ba1d5f51d3;0;4;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;2;FLOAT;0;FLOAT;37
Node;AmplifyShaderEditor.TFHCRemapNode;136;2447.803,-433.1236;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.3;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;140;2242.279,-390.2271;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;134;1722.323,-339.7679;Inherit;False;Property;_VignetteRadiuse;Vignette Radiuse;9;0;Create;True;0;0;0;False;0;False;0.22;0.22;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;142;2699.324,-431.1644;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;141;2876.324,-481.1644;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;143;2875.324,-164.1644;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
WireConnection;100;1;45;0
WireConnection;100;2;143;0
...
WireConnection;139;1;4;0
WireConnection;139;2;128;0
WireConnection;139;3;127;0
WireConnection;139;4;134;0
WireConnection;136;0;140;0
WireConnection;140;0;139;37
WireConnection;142;0;136;0
WireConnection;141;0;142;0
WireConnection;141;1;142;0
WireConnection;143;0;141;0
ASEEND*/
//CHKSM=70D1E89694290129EA8C8FE449BE52985690E384